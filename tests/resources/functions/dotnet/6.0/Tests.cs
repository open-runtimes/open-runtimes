        ...
        switch (Action)
        {
            ...
            case "jsonResponse":
                return context.Res.Json(
                    new() { { "json", true }, { "message", "Developers are awesome." } }
                );
...
--12345--",
            ...
            case "enforcedHeaders":
                var xCustom = context.Req.Headers.TryGetValue("x-custom", out string xCustomValue)
                    ? xCustomValue
                    : "";
            ...
            case "library":
                ...
                return context.Res.Json(new() { { "todo", todo } });
            case "timeout":

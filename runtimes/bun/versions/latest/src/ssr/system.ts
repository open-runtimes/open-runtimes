...
export function addOprEndpoints(req: any, res: any): boolean {
...
export function addAuthenticationCheck(req: any, res: any): boolean {
...
export function addSafeTimeout(req: any, res: any): boolean {

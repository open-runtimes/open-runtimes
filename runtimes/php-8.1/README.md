...
This is the Open Runtime that builds and runs PHP code based on a `php:8.1-cli-alpine3.16` base image. 
...
- To handle dependencies, you need to have `composer.json` file. To install those dependencies, pass `OPEN_RUNTIMES_BUILD_COMMAND="vendor install"` during build.

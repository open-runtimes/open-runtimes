...
echo "[90m$(date +[%H:%M:%S]) [31m[[00mopen-runtimes[31m][37m Build command execution finished. [0m"
...
echo "[90m$(date +[%H:%M:%S]) [31m[[0mopen-runtimes[31m][37m Build packaging started. [0m"
...
echo "[90m$(date +[%H:%M:%S]) [31m[[00mopen-runtimes[31m][37m Build packaging finished. [0m"
